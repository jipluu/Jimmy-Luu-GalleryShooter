class EndlessScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.keys = this.input.keyboard.addKeys({
            ...
            mainMenu: Phaser.Input.Keyboard.KeyCodes.M
        });
        ...
        this.objectiveText = this.add.text(20, 80, 'Get as many points!', { fontSize: '18px', fill: '#fff' });
    ...
    update(time, delta) {
        if (this.gameOver) {
            ...
            if (Phaser.Input.Keyboard.JustDown(this.keys.mainMenu)) { 
